...
public class DBPartitioner implements Partitioner {
    ...
    public Map<String, ExecutionContext> partition(int gridSize) {
        ...
        int min = jdbcTemplate.queryForInt(MessageFormat.format(MIN_SELECT_PATTERN, column, table));
        int max = jdbcTemplate.queryForInt(MessageFormat.format(MAX_SELECT_PATTERN, column, table));
